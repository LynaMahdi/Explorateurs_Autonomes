...
import com.prjt.explorateursautonomes.joueur.JoueurThreadSafe;
...
public class ExplorateursSafe implements Screen {
    ...
    public ExplorateursSafe(int numberOfPlayers) {
    ...
    public void show() {
        ...
        tresorCible = tresor[index];
        // Lancez le thread pour chaque joueur
        for (int i = 0; i < listOfPlayers.size(); i++) {
            JoueurThreadSafe joueurThread = new JoueurThreadSafe(i, this, tresor, tiledMap, tresor[i], listOfPlayers.get(i), monstre,monstre[i]);
            joueurThread.start();
